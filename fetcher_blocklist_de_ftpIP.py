...
feedaddr = 'http://www.blocklist.de/lists/ftp.txt'
feedID = 'blocklist_de_ftp'
mkey = 'fetcher_blocklist_de_ftpIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'FTP scanners'))
