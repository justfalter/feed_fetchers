...
feedaddr = 'http://www.blocklist.de/lists/pop3.txt'
feedID = 'blocklist_de_pop3'
mkey = 'fetcher_blocklist_de_POP3IP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'POP3 scanners'))
