...
feedaddr = 'https://spyeyetracker.abuse.ch/blocklist.php?download=domainblocklist'
feedID = 'spyeyetracker'
mkey = 'fetcher_spyeyeDomain:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'SpyEye C&C'))
