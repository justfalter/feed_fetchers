...
feedaddr = 'http://www.blocklist.de/lists/bots.txt'
feedID = 'blocklist_de_bots'
mkey = 'fetcher_blocklist_de_botsIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'Bots & scanners'))
