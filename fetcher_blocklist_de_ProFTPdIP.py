...
feedaddr = 'http://www.blocklist.de/lists/proftpd.txt'
feedID = 'blocklist_de_proftpd'
mkey = 'fetcher_blocklist_de_ProFTPdIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'ProFTPd scanners'))
