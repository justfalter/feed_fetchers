...
feedaddr = 'http://www.blocklist.de/lists/strongips.txt'
feedID = 'blocklist_de_strongips'
mkey = 'fetcher_blocklist_de_strongIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'Persistent IPs'))
