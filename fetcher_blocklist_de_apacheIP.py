...
feedaddr = 'http://www.blocklist.de/lists/apache.txt'
feedID = 'blocklist_de_apache'
mkey = 'fetcher_blocklist_de_apacheIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'Apache scanners'))
