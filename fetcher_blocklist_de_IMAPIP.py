...
feedaddr = 'http://www.blocklist.de/lists/imap.txt'
feedID = 'blocklist_de_imap'
mkey = 'fetcher_blocklist_de_IMAPIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'IMAP scanners'))
