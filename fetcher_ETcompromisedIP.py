...
feedaddr = 'http://rules.emergingthreats.net/open/suricata/rules/compromised-ips.txt'
feedID = 'emergingthreats_compromised'
mkey = 'fetcher_ETcompromisedIP:feeddata'
killchain = 'unknown'
