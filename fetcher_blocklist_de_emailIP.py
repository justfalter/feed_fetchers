...
feedaddr = 'http://www.blocklist.de/lists/email.txt'
feedID = 'blocklist_de_email'
mkey = 'fetcher_blocklist_de_emailIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'Email scanners'))
