...
feedaddr = 'http://atlas.arbor.net/summary/domainlist'
feedID = 'arborfastflux'
mkey = 'fetcher_arbor_fastflux:feeddata'
killchain = 'Delivery'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'Arbor Fastflux Domain'))
