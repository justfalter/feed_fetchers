...
feedaddr = 'http://www.blocklist.de/lists/ssh.txt'
feedID = 'blocklist_de_ssh'
mkey = 'fetcher_blocklist_de_SSHIP:feeddata'
...
for x in splitlines:
	...
	if len(x) == 0: continue
	print("%s,%s,%s,%s" % (x, feedID, killchain, 'SSH scanners'))
