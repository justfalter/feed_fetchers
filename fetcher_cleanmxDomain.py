...
print('domain,feedID,killchain,description,md5,vt_score,ipv4,email,url')
...
for entry in xmlroot.getElementsByTagName("entry"):
	...
	if entry.getElementsByTagName('domain')[0].firstChild == None: continue
	...
	sys.stdout.write(',')
	if entry.getElementsByTagName('ip')[0].firstChild != None:
